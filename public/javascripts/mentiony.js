...
(function ($) {
    ...
    jQuery.fn.hashMentiony = function (method, options) {
        var defaults = {
             ...
             */
            onDataRequestHash: function (mode, keyword, onDataRequestCompleteCallback) {
    ...
    var MentionsInput = function (settings) {
        ...
        function initTextArea(ele) {
            ...
            if (elmInputBox.attr('data-mentions-input') == 'true') {
                ...
                console.log(elmInputBox.attr('id').length);
        ...
        function doSearchAndShow() {
            ...
            if (settings.timeOut > 0) {
                ...
                settings.globalTimeout = setTimeout(function () {
                    ...
                    settings.onDataRequestHash.call(this, 'search', currentMention.keyword, onDataRequestCompleteCallback);
